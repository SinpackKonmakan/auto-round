...
CUDA_VISIBLE_DEVICES=$device python -m auto_round \
        ...
        --output_dir /data5/shiqi/model/${format}_q2_k_s_${model_name}_search_nt_ns20_20times \
        --eval_bs 16 \
        --tasks arc_challenge,arc_easy,boolq,hellaswag,lambada_openai,mmlu,openbookqa,piqa,truthfulqa_mc1,winogrande \
        2>&1 | tee /data5/shiqi/log/${format}_q2_k_s_${model_name}_search_nt_ns20_20times.log
done