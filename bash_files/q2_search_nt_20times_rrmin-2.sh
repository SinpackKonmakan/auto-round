...
CUDA_VISIBLE_DEVICES=$device python -m auto_round \
        ...
        --output_dir /data5/shiqi/model/q2_${format}_${model_name}_search_nt_20times_rrmin-2 \
        --eval_bs 16 \
        --tasks lambada_openai,arc_challenge,arc_easy,boolq,hellaswag,mmlu,openbookqa,piqa,truthfulqa_mc1,winogrande \
        2>&1 | tee /data5/shiqi/log/q2_${format}_${model_name}_search_nt_20times_rrmin-2.log
done