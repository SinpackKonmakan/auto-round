...
CUDA_VISIBLE_DEVICES=$device python -m auto_round \
        ...
        --output_dir /data5/shiqi/model/q4_${format}_${model_name}_search_nt_ns20_20times_2 \
        --eval_bs 16 \
        --tasks arc_challenge,arc_easy,boolq,hellaswag,lambada_openai,mmlu,openbookqa,piqa,truthfulqa_mc1,winogrande \
        2>&1 | tee /data5/shiqi/log/q4_${format}_${model_name}_search_nt_ns20_20times_2.log
done